...
import { getOverlayRect, getTransformHandleRect, type GeometryRect } from "../e2e/helpers/geometry.js";
import { REAL_ARTIFACT_DIR } from "./constants.js";
import { rect } from "../e2e/helpers/geometry.js";
...
export async function captureOracle(page: Page, target: Locator): Promise<VisualOracle> {
